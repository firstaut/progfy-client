        ...
        <div className="container h-100">
          <div className="row h-100 align-items-center">
            <div className="col-lg-12 franja_negra">
              <h2 className="display-6 text-white font-weight-bold mt-5 mb-2 text-uppercase text-center">
                Primera plataforma de entrenamiento online en Automatización y
                Digitalización Industrial
              </h2>
              <h5 className="mb-5 text-white text-center mt-4">
                Programa equipos reales cuando quieras y desde donde quieras
              </h5>
              <div className="row justify-content-center">
                <a
                  className="btn btn-info ml-3 mb-4 p-3 text-decoration-none text-white"
                  href="#saberMas"
                >
                  CONOCER MÁS
                </a>
      ...
      <div className="container">
        <div id="saberMas" className="row">
          <div className="col-md-8 mb-5">
            ...
            {customer ? (
              <Link
                className="btn btn-info btn-lg text-decoration-none text-white"
                to="/dashboard"
              >
                IR AL DASHBOARD
              </Link>
